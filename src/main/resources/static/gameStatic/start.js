    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        $(".click").on('click', function () {
          ...
          var requestUrl = "http://localhost:8080/check?name=" + inhalt
          $.ajax({
            url: requestUrl,
            type: 'GET',
                ...
                $.ajax({
                  ...
                  success: function (data) {
                    ...
                    $(".click1").on('click', function () {
                      var inhalt = $(this).text();
                      var requestUrl = "http://localhost:8080/check2?name=" + inhalt
                      $.ajax({
                        url: requestUrl,
                        type: 'GET',
                        success: function (result) {
                            ...
                            $.ajax({
                              ...
                              success: function (data) {
                                ...
                                $(".click3").on('click', function () {
                                  var inhalt = $(this).text();
                                  var requestUrl = "http://localhost:8080/check3?name=" + inhalt
                                  $.ajax({
                                    url: requestUrl,
                                    type: 'GET',
                                    success: function (result) {
